...
| **C-res** | Router **`step_stride`**（決定的）のログ | **デモ + gpt2 実モデル 記録済** | デモ: [`two_tier_sweep_stride4_demo_summary_v1.json`](../../experiments/baselines/two_tier_sweep_stride4_demo_summary_v1.json)；**gpt2・CPU**: [`two_tier_stride4_gpt2_cpu_full.json`](../../experiments/baselines/two_tier_stride4_gpt2_cpu_full.json)；**gpt2・MPS・P0 同梱**（sweep+HBM）: [`phase3_claim_gpt2_mps_stride4_summary_v1.json`](../../experiments/baselines/phase3_claim_gpt2_mps_stride4_summary_v1.json) | — |
