...
| **Phase II-A 合成（μ 感度）** | alpha スイープ・理論橋 1 JSON | [`v7_phase2a_delay_sweep.py`](../../experiments/v7_phase2a_delay_sweep.py) `--alpha-list`（[数値 τ 説明](v7_phase2a_numeric_tau_exp.md)）。束ね: [`v7_phase2a_theory_bridge_synth.py`](../../experiments/v7_phase2a_theory_bridge_synth.py) |
